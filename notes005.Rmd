...
This is referred to as **linear stability analysis** and the stated criterion is derived in section 2.4 of [@strogatzNonlinearDynamicsChaos2015]. 
...
```{r a_phaseline_again,eval=FALSE}
library(phaseR)
f <- function(t,x,parameters){list(x*(1-x))}
a_phaseline <- phasePortrait(f,ylim   = c(-0.5, 1.5),
                                        points = 10,
