...
### Cobweb for Discrete Logistic

To see and interact with the cobweb diagram for the discrete logistic model, check out  [this shiny web app]( https://jmgraham30rs.shinyapps.io/discrete_logistic/).
...
Let's zoom in a bit and take a closer look at what is happening after $r$ gets to 3. 
...
For more on discrete time models and linear difference equations in particular, see chapter 2 of [@allenIntroductionMathematicalBiology2007] or chapter 1 of [@devriesCourseMathematicalBiology2006]. Both of these books also contain references to further reading on the topics of difference equations and their applications within biomathematics.
