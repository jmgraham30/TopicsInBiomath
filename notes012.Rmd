...
\end{align*}
$$
The first equation is the equation for the neuron action potential and the other equations are called gating variables. The gating variables relate to probabilities for various ions (electrically charged molecules) to pass through the neuronal cell membrane. Here, we solve these equations numerically just to illustrate how this can be done with `deSolve`.  
