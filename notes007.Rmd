...
Before we develop a mathematical model for the chemostat it is helpful to see what one looks like. Good illustrations can be found in the [Wikipedia page for chemostat](https://en.wikipedia.org/wiki/Chemostat) or at [this image link](https://images.app.goo.gl/NEY7zuNu2bywjqZE6).
...
We can present this as a compartment model. 
